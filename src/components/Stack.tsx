    ...
    >
        ...
        <div className="text-5xl font-alkatra mx-auto px-4 lg:w-1/3">Favorite stack
            <div className="text-2xl font-sans font-semibold">
                ...
                <div><span className="font-alkatra text-transparent text-3xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">R</span> - ReactJS</div>
                <div><span className="font-alkatra text-transparent text-3xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">N</span> - NodeJS</div>            
            </div>        
        </div>
    </motion.div>
  )
