  ...
  return (
    <div className="flex flex-wrap w-5/6 max-w-[940px] m-auto ">
      ...
      <div className="w-full flex flex-wrap py-10">
        ...
        <div className='relative flex w-2/3 justify-center md:justify-start'>
            <img className="h-auto w-[500px] absolute translate-x-52 -translate-y-10" src="./images/animation.png" /> 
            <img className="h-auto w-72 z-10" src="./images/animationMobile.png" /> 
        </div>   
      </div>

      <div className="w-full flex flex-wrap">
        <div className='relative flex w-2/3 justify-center md:justify-start'>
            <img className="h-auto w-[600px]" src="./images/laptopguy.png" />  
        </div>      
        <div className="lg:w-1/3">
