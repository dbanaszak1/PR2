...
const Expect = () => {
  return (
    <div className="flex flex-wrap w-5/6 max-w-[940px] m-auto text-center md:text-left overflow-hidden">
      ...
      <div className="w-full flex flex-wrap">
        <div className='relative flex w-2/3 justify-center md:justify-start'>
            <img className="h-auto w-40 lg:w-80 absolute translate-x-20 lg:translate-x-48 rotate-12 " src="./images/rspRentMe.png" /> 
            <img className="h-auto w-40 lg:w-80 z-10" src="./images/rspSkyTravel.png" /> 
        </div>      
        <div className="lg:w-1/3">
            ...
            <motion.p
              ...
              viewport={{ once: true }} 
              className="text-gray-600 w-2/3 m-auto lg:m-0">
      ...
      <div className="w-full flex flex-wrap py-10 border-t-[1px] border-gray-300 lg:border-none">
        <div className="lg:w-1/3">
            <motion.h2 
              initial={{opacity:0, x:'-50%'}}
              whileInView={{opacity:1, x:'0'}}
        ...
        <div className='relative flex w-2/3 justify-center md:justify-start'>
            <img className="h-auto w-[500px] absolute translate-x-28 md:translate-x-52 lg:-translate-y-10" src="./images/animation.png" /> 
            <img className="h-auto w-36 lg:w-72 z-10" src="./images/animationMobile.png" /> 
        </div>   
      </div>

      <div className="w-full flex flex-wrap border-t-[1px] border-gray-300 lg:border-none py-6">
        <div className='relative flex lg:w-2/3 justify-center md:justify-start'>
      ...
      <div className="w-full flex flex-wrap py-6 m-auto lg:m-0 border-t-[1px] border-gray-300 lg:border-none">
        <div className="lg:w-1/3">
            <motion.h2 
              className="font-alkatra text-transparent text-3xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"
              initial={{opacity:0, x:'-50%'}}
        ...
        <div className='relative flex w-full lg:w-2/3 justify-center md:justify-start'>
            <img className="h-auto w-[500px] lg:absolute lg:translate-x-20 lg:-translate-y-24" src="./images/programmer2.png" />             
        </div>   
      </div>
    </div>
  )
